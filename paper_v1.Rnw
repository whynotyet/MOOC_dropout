...
In this study, we used 17 MOOCs from different areas including humanities sciences (4 courses), engineering (2 courses), computer science (3 courses), mathematics and statistics (6 courses), and business (2 instances of 1 course). For each course, we acquired the data from the pre-and post-course surveys, as well as the learner activity data from the online platform. From each course, we selected all learners who took the post-course survey, and we matched learners to their activity data and pre-course survey response (if available).

The post-course survey for each course asked the learners a range of questions about quality of experience with the course (Extremely dissatisfied - Extremely satisfied, 7 point scale), the extent to which they found it difficult/easy (Extremely easy - Extremely difficult, 7 point scale), whether or not they have stopped participating before the end of the course, and if they did, what reasons influenced their decision to stop. For each reason, the student was asked to select one of two options: "Did influence my decision to stop" and "Did NOT influence my decision to stop". Compared to a question where the student only checks a box if the reason applies, this design aims to distinguish between respondents who skip reportinga reason and those who express that the reason did not apply to them.

Table \ref{tab:study1_courses_summary} shows the number of enrolled learners, percentage of learners who took the post-course survey, percentage who took both the pre- and post-course surveys, distributions of age, gender, and education level, and the proportion of learner who reported in the post-course survey that they stopped participating in the course before the end. The table also shows the proprtions of learners who viewed at least $30\%$/$50\%$/$80\%$ of the course videos. Note that the target of this study are the learners who took the post-course survey, whereas the demographic questions are asked in the pre-course survey. The age, gender, and education statistics are thus computed from the learners who took both surveys, which might be different from the statistics of the post-course survey takers, pre-course takers, or whole course learner population.
...
\newcommand{\specialcellcentered}[2][c]{%
...
\caption{Summary on courses and surveys used in Study 1}
\small
\center
\begin{tabular}{llrrrrrrrrrr}
\toprule
ID & Topic Area & Enrollment & Pre-survey & Post-survey & Female & Age & Education & \specialcellcentered{\ensuremath{>} 30\% \\ videos} & \specialcellcentered{\ensuremath{>} 50\% \\ videos} & \specialcellcentered{\ensuremath{>} 80\% \\ videos} & \specialcellcentered{Self-Rep. \\ Dropout} \\
\midrule
C1 & Business & 61096 & 9943 & 2367 & 42\% & 39 (30,49) & n/a & 39\% & 20\% & 7\% & 10\% \\
C2 & Business & 41081 & 6544 & 883 & 40\% & 39 (30,49) & 97\% & 32\% & 13\% & 2\% & 9\% \\
C3 & Comp. Sc. & 27104 & 6104 & 2854 & 35\% & 30 (22,41) & 74\% & 67\% & 40\% & 7\% & 2\% \\
C4 & Comp. Sc. & 56154 & 3406 & 1123 & 11\% & 33 (27,42) & 91\% & 34\% & 16\% & 11\% & 21\% \\
C5 & Comp. Sc. & 57636 & 5738 & 402 & 17\% & 33 (26,43) & 91\% & 66\% & 55\% & 28\% & 14\% \\
C6 & Engineering & 16220 & 2540 & 269 & 13\% & 33 (27,45) & 92\% & 62\% & 49\% & 17\% & 15\% \\
C7 & Enginerring & 7178 & 1312 & 202 & 12\% & 27 (22,39) & 85\% & 51\% & 18\% & 2\% & 7\% \\
C8 & Humanities & 7634 & 3631 & 152 & 92\% & 33 (26,45) & 93\% & 45\% & 11\% & 0\% & 7\% \\
C9 & Humanities & 6475 & 3315 & 326 & 90\% & 32 (27,47) & 91\% & 69\% & 50\% & 17\% & 16\% \\
C10 & Humanities & 9903 & 4227 & 1570 & 52\% & 39 (29,52) & 89\% & 84\% & 74\% & 21\% & 3\% \\
C11 & Humanities & 630 & 167 & 80 & 50\% & 30 (27,40) & 97\% & 74\% & 55\% & 16\% & 16\% \\
C12 & Math \& Stats & 49317 & 3090 & 862 & 33\% & 41 (29,55) & 88\% & 27\% & 10\% & 1\% & 31\% \\
C13 & Math \& Stats & 32006 & 26142 & 5336 & 58\% & 28 (16,46) & n/a & 69\% & 38\% & 8\% & 4\% \\
C14 & Math \& Stats & 16857 & 2892 & 363 & 9\% & 31 (26,38) & 99\% & 61\% & 45\% & 25\% & 14\% \\
C15 & Math \& Stats & 37017 & 11629 & 1854 & 20\% & 35 (29,45) & 98\% & 78\% & 67\% & 34\% & 8\% \\
C16 & Math \& Stats & 27236 & 2711 & 637 & 82\% & 43 (34,51) & n/a & 64\% & 36\% & 5\% & 1\% \\
C17 & Math \& Stats & 13132 & 3629 & 843 & n/a & n/a & n/a & 70\% & 54\% & 14\% & 5\% \\
\bottomrule
\end{tabular}
\end{table*}


% Proportions for each dropout reason for each course
We are interested in the proportions of respondents that reported each reason for dropout across the courses. These proportions are shown in [Ref to Box plot]. The proprtion for each reason was computed as the number of respondents who reported that the reason applied to them divided by the total number of those who responded to the question (reporting that it aplies or that it does not apply). We also computed the median and interquartile range of the proprtions across all courses for each reason. 



% Correlations among rfd's and between rfd's and ei's.
For each  course, we also computed the correlations between the reported reasons for dropout (Table \ref{tab:study1_rfd_corr}), and the correlations between reported reasons for dropout and enrollment intentions (Table \ref{tab:study1_rfd_ei_corr}). Each table shows a linear combination of the correlation matrices of the 17 courses.

% Proportion videos watched for each disengagement reason
We are also interested in the correlations between reported reasons for dropout and certain learner behaviors. For each learner, we computed the fraction of course videos visited (the learner started playing the video) and fraction watched (the learner stayed with the video for 3 minutes, or for the whole video duration if shorter than 3 minutes). We then computed the matrix of correlations between reasons for dropout and these variables for each course. These matrices were averaged and the result is shown in Table \ref{tab:study1_rfd_video_behavior_corr}.
