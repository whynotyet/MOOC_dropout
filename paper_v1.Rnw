...
Report results of factor analysis here.
...
Attrition can be a sign of success if a learner has achieved their personal goal. We therefore investigated what proportion of learners who dropped out were satisfied with their achievements in the course (RQ2). TODO add satisfaction analysis here
