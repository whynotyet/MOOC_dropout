...
a = read.csv("compiled_data_all_courses.csv")
...
<<study1_satis_si_score_dist_comparison, echo=FALSE, fig.env='figure*', fig.pos='ht', fig.height=4, fig.width=9, fig.cap='Satisfaction index scores for learners who reported they stopped / did not stop participating before end of course'>>=
y0 = a$satisfaction[a$did_dropout == "No"]
y1 = a$satisfaction[a$did_dropout == "Yes"]
