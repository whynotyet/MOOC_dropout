...
In this study, we used 17 MOOCs from different areas including humanities sciences (4 courses), engineering (2 courses), computer science (3 courses), mathematics and statistics (6 courses), and business (2 instances of 1 course). For each course, we acquired the data from the pre-course and post-course surveys, as well as the learner activity data from the platform hosting the course. From each course, we selected all learners who took the post-course survey, and we matched learners to their activity data and pre-course survey response (if available). Table \ref{tab:study1_courses_summary} shows the number of enrolled learners, number of learners who responses to the pre-course/post-course survey, distributions of age, gender, and education level, and the proportion of learner who self-reported that they stopped participating in the course. We also computed the proprtions of learners who viewed at least $p$\% of the course videos for $p = 30\%$, $50\%$, and $80\%$.
